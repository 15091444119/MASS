    ...
    with open(dict_path, 'r') as f:
        for line in f:
            ...
            if src in src_word2id and tgt in tgt_word2id:
                ...
                dropped_pair_count += 1
    print("Dropped {} pairs, resulting in dictionary of {} source words".format(dropped_pair_count, len(dic)),
          file=sys.stderr)
    return dic
...
class BLI(object):
    ...
    def translate_words(
        ...
        translation = retrieval(src_embeddings, tgt_embeddings, src_ids_to_translate, csls_topk=self._csls_topk,
                                batch_size=self._batch_size, metric=self._metric)
