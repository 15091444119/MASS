...
def load_mass_model(model_path):
    ...
    encoder = TransformerModel(model_params, dico, is_encoder=True, with_output=True).cuda()
    decoder = TransformerModel(model_params, dico, is_encoder=False, with_output=True).cuda()
