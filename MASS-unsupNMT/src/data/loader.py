...
def check_eval_params(params):
    ...
    params.eval_explicit_mass_steps = [lang for lang in params.eval_explicit_mass_steps.split(',') if len(lang) > 0]
    if len(params.eval_explicit_mass_steps) != 0:
        assert all([l in params.langs for l in params.eval_explicit_mass_steps])
